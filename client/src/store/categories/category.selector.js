...
/**
    ...
    The first argument is that reducer from our reducer store, which we want to memoize,
...
export const selectCategoriesMap = createSelector(
  ...
  (categories) =>
    categories.reduce((acc, category) => {
      //here .docs is a methods to fetch the documents, which are hats, jackets etc
